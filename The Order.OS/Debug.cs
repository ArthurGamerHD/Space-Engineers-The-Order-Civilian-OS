                ...
                case 1:
                    if (frame.Count == 0)
                    {
                            ...
                            $"{HWText}";
                        {
                            ...
                            frame.Add(new MySprite(SpriteType.TEXT, DebugText, new Vector2(-220f, -147f) * Z + P, null, new Color(255, 255, 255, 255), "DEBUG", TextAlignment.LEFT, .9f * Z));
                            frame.Add(new MySprite(SpriteType.TEXT, "      Debug Info:", new Vector2(-128f, -193f) * Z + P, null, new Color(255, 255, 255, 255), "DEBUG", TextAlignment.LEFT, 1.3f * Z));
                            ...
                            frame.Add(new MySprite(SpriteType.TEXT, "Debug Info Display V2.0.1", new Vector2(-88f, -237f) * Z + P, null, new Color(255, 255, 255, 255), "DEBUG", TextAlignment.LEFT, 1f * Z)); // Title
                            frame.Add(new MySprite(ST, SS, new Vector2(50f, -200f) * Z + P, new Vector2(380f, 5f) * Z, new Color(255, 255, 255, 255), null, TA)); // WhiteLine
                            ...
                            frame.Add(new MySprite(ST, "Circle", new Vector2(-183f, -200f) * Z + P, new Vector2(80f, 80f) * Z, new Color(255, 255, 255, 255), null, TA)); // WhiteCircle
                            frame.Add(new MySprite(ST, Window.Meta.FactionIcon, new Vector2(-183f, -200f) * Z + P, new Vector2(80f, 80f) * Z, Window.Meta.FactionColor, null, TA)); // WhiteCircle
